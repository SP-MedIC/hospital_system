...
class _PatientInformationState extends State<PatientInformation> {
  ...
  void _updateServiceInUse(String docId, String? newValue) async {
    ...
    FirebaseFirestore.instance
        ...
        .collection('patient')
        .doc(docId)
        .update({'service_in_use': newValue})
        .then((value) {
      ...
      if (previousValue != null && previousValue != newValue) {
        ...
        FirebaseFirestore.instance
            .collection('hospitals')
            .doc(FirebaseAuth.instance.currentUser!.uid)
            .update({'services.$previousValue': FieldValue.increment(-1)});
      }
        ...
        FirebaseFirestore.instance
            .collection('hospitals')
            .doc(FirebaseAuth.instance.currentUser!.uid)
            .update({'services.$newValue': FieldValue.increment(1)});
      }
  ...
  DropdownButton<String> buildDropdownButton2(selectedType, List<String> services, DocumentSnapshot<Object?> doc) {
    return DropdownButton<String>(
          ...
          onChanged: (String? newValue) {
            ...
            _updateServiceInUse(doc.id, newValue);
            });
          },
        );
  }
